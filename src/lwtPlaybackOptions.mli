...
val consume: LwtClient.t -> bool -> Protocol.response Lwt.t

(** Sets crossfading between songs. *)
val crossfade: LwtClient.t -> int -> Protocol.response Lwt.t
...
val mixrampdb: LwtClient.t -> int -> Protocol.response Lwt.t
...
val mixrampdelay: LwtClient.t -> mixrampd_t -> Protocol.response Lwt.t

(** Sets random state to STATE, STATE should be true or false *)
val random: LwtClient.t -> bool -> Protocol.response Lwt.t

(** Sets repeat state to STATE, STATE should be false or true. *)
val repeat: LwtClient.t -> bool -> Protocol.response Lwt.t

(** Sets volume to VOL, the range of volume is 0-100. *)
val setvol: LwtClient.t -> int -> Protocol.response Lwt.t
...
val single: LwtClient.t -> bool -> Protocol.response Lwt.t
...
val replay_gain_mode: LwtClient.t -> gain_mode_t -> Protocol.response Lwt.t
