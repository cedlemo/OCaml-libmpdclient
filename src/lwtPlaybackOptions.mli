...
val consume: LwtClient.t -> bool -> Protocol.response option Lwt.t

(** Sets crossfading between songs. *)
val crossfade: LwtClient.t -> int -> Protocol.response option Lwt.t
...
val mixrampdb: LwtClient.t -> int -> Protocol.response option Lwt.t
...
val mixrampdelay: LwtClient.t -> mixrampd_t -> Protocol.response option Lwt.t

(** Sets random state to STATE, STATE should be true or false *)
val random: LwtClient.t -> bool -> Protocol.response option Lwt.t

(** Sets repeat state to STATE, STATE should be false or true. *)
val repeat: LwtClient.t -> bool -> Protocol.response option Lwt.t

(** Sets volume to VOL, the range of volume is 0-100. *)
val setvol: LwtClient.t -> int -> Protocol.response option Lwt.t
...
val single: LwtClient.t -> bool -> Protocol.response option Lwt.t
...
val replay_gain_mode: LwtClient.t -> gain_mode_t -> Protocol.response option Lwt.t
